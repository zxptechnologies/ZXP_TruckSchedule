...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    <script src="Scripts/GridTemplates/YardMuleRequestOverview_CompleteGrid.js"></script>
    <script src="Scripts/GridTemplates/YardMuleRequestOverview_YardmuleGrid.js"></script>
</asp:Content>
         ...
         function onSuccess_getYardMuleRequestGridData(value, ctx, methodName) {
             ...
             for (i = 0; i < value.length; i++) {
                 ...
                 newYardMuleRequestData[i] = {
                     ...
                     "TRAILERNUM": trailernum, "isOpenInCMS": isOpenInCMS, "PRODCOUNT": value[i][26], "PRODID": value[i][27], "PRODDETAIL": value[i][28], "SPOTETA": value[i][29]
                 };
             }
        ...
        -------------------------------------------------------%>
         $(function () {
            ...
            if (GLOBAL_IS_MOBILE_VIEWING) {
                hide_completeGrid();
                init_yardmuleRequestOverviewGrid_Mobile();
                init_yardmuleRequestOverviewGrid_CompleteGridMobile();
                ...
                init_yardmuleRequestOverviewGrid_Regular();
                init_yardmuleRequestOverviewGrid_CompleteGridRegular();
             ...
             $(document).delegate("#yardmulegrid", "iggridcellclick", function (evt, ui) {
                 if (ui.colKey === 'TSTART' || ui.colKey === 'TEND' || ui.colKey === 'PRODDETAIL' || ui.colKey === 'FUPLOAD' || ui.colKey === 'IMGUP') {
    ...
    <table id="completedGrid" class="scrollGridClass"></table></div>
     ...
     <div id ="editDialog">
        <table style="border: 0;">
            ...
            <tr><td><label class="mobileLbl">Originally Assigned Spot:  </label></td><td><label class="mobileLbl" id="originalSpotEditDialog"> </label></td></tr>
