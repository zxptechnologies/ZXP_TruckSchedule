...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function onClick_UpdatePOStatus() {
            showProgress();
            if ($('#cboxBypass').is(":checked")) {
                PageMethods.updateIsOpenInCMSStatusWithByPass(onSuccess_updateIsOpenInCMSStatus, onFail_updateIsOpenInCMSStatus);
            }
            else {
	...
	<div>
		...
		<input type="checkbox" id="cboxBypass" name="bypass" value="bypass">By Pass conditions when closing out trucks?
		</div>
    <h3><span id="Span1">
