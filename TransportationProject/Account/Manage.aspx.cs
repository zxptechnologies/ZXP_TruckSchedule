    ...
    public partial class Manage : System.Web.UI.Page
    {
        ...
        protected void setPassword_Click(object sender, EventArgs e)
        {
            if (IsValid)
            {
                ...
                {
                    //Response.Redirect("~/Account/Manage?m=SetPwdSuccess"); //for internal testing
                    Response.Redirect("~/Account/Manage?m=SetPwdSuccess"); //zxp live
                }
                else
                {
        ...
        public void RemoveExternalLogin(string providerName, string providerUserId)
        {
            var m = OpenAuth.DeleteAccount(User.Identity.Name, providerName, providerUserId)
                ...
                : String.Empty;
           // Response.Redirect("~/Account/Manage" + m);//for internal testing
            Response.Redirect("~/Account/Manage" + m);//zxp live
        }
