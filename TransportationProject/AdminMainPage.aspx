...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Menu ID="NavigationMenu" runat="server" Orientation="Horizontal" onmenuitemclick="adminMenuItemClick" >
        <Items>
            <asp:MenuItem Target="iframeContent" NavigateUrl="~/Admin_AppSettings.aspx" Text="Application Settings"></asp:MenuItem>
            ...
            <asp:MenuItem Target="iframeContent" NavigateUrl="~/Admin_CleanUp.aspx" Text="Schedule Clean Up"></asp:MenuItem>
        </Items>
    </asp:Menu>
