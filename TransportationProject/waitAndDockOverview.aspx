...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
            ...
            $("#releasedGrid").igGrid({
                ...
                columns:
                    [
                        ...
                        { headerText: "Trailer#", key: "TRAILER", dataType: "string", width: "150px" },
                             {
                                 headerText: "Part Number", key: "PRODID", dataType: "string", width: "150px",
                             ...
                             { headerText: "", key: "PRODCOUNT", dataType: "number", width: "0px", hidden: true },
                             {
                                 headerText: "Product", key: "PRODDETAIL", dataType: "string", width: "150px",
                                 template: "{{if(${PRODCOUNT} == 0 )}} N/A " +
                                            "{{elseif (${PRODCOUNT} < 2)}}<div>${PRODDETAIL}</div>" +
            ...
            $("#samplesGrid").igGrid({
                ...
                columns:
                    [
                        ...
                        { headerText: "Sample ID", key: "SAMPLEID", dataType: "id", width: "0px" },
                        { headerText: "Part Number", key: "PRODUCT", dataType: "string", width: "250px" },
                        { headerText: "Product", key: "PRODUCTDETAILS", dataType: "string", width: "250px" },
                        {
    ...
    <br />
    <div id="dvScheduled">
        <table id="scheduledGrid" class="scrollGridClass" ></table>
    </div>
    <div>
        <div style="float: right">
    ...
    <br />
    <div id="dvInYard">
        <table id="inYardGrid" class="scrollGridClass" ></table>
    </div>
    ...
    <br />
    <div id="dvSamples">
        <table id="samplesGrid" class="scrollGridClass" ></table>
    </div>
    <div>
        <div style="float: right">
    ...
    <div id="dvInspections">
        <table id="inspectionsGrid" class="scrollGridClass"></table>
    </div>
    <div>
        <div style="float: right">
    ...
    <br />
    <div id="dvWait">
        <table id="waitingGrid" class="scrollGridClass"></table>
    </div>
    <div>
        <div style="float: right">
    ...
    <br />
    <div id="dvBulk">
        <table id="bulkGrid" class="scrollGridClass"></table>
    </div>
    <div>
        <div style="float: right">
    ...
    <br />
    <div id="dvVan">
        <table id="vanGrid" class="scrollGridClass"></table>
    </div>
    <div>
        <div style="float: right">
    ...
    <br />
    <div id="dvReleased">
        <table id="releasedGrid" class="scrollGridClass"></table>
    </div>
