         ...
         function init() {
             ...
             $("#demurrageGrid").igGrid({
                 ...
                 columns: [
                     ...
                     { headerText: "Recieve Alert", key: "USERALERT", dataType: "bool", width: "85px" },
                        ...
                        editRowEnded: function (evt, ui) {
                            ...
                            if (ui.update == true && ui.rowAdding == false && ((evt.originalEvent.type == "click" && evt.originalEvent.currentTarget.innerText == "Done") || evt.keyCode == 13)) {
                                ...
                                if ((ui.values.SMS == true && ui.values.EMAIL == true) || (ui.values.SMS == true && ui.values.EMAIL == false && GLOBAL_SMS_ALERTFLAG == true) || (ui.values.SMS == false && ui.values.EMAIL == false) || hasCell == true) {
                                    ...
                                    var res = confirm(uName + " can not recieve this alert as a text message because there is not a cell phone number for him/her in the system. They will still be able to recieve this alert as an email. Would you like to contitue to add this alert to " + uName + "?");
                                    if (res == true) {
