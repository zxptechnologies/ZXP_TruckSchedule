...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function onSuccess_getProductOptions(value, ctx, methodName) {
            ...
            GLOBAL_PRODUCT_OPTIONS_FOR_EVENT_ALERTS.unshift({ "PRODUCT": "ALL", "PRODUCTTEXT": "All Products" });
        ...
        function convertHoursToMins(days) {
            return Hours * 60;
        }
        ...
        function checkToSeeIfNameExsist(alertName, alertID, alertType) {
            var dataSet = [];
                    ...
                    { name: 'Sorting' },
                    {
                       ...
                       editRowEnding: function (evt, ui) {
                           ...
                           if (ui.update == true && ui.rowAdding == true && ((evt.originalEvent.type == "click" && evt.originalEvent.currentTarget.innerText == "Done") || evt.keyCode == 13)) {
                               ...
                               if (checkToSeeIfNameExsist(ui.values.NAME, 0, 'demurrage') == true) {
                                   ui.keepEditing = true;
                                   alert("This alert name already exsist. Please re-name and try saving again");
                                   return false;
                               }
                               else {
                               ...
                               if (checkToSeeIfNameExsist(ui.values.NAME, ui.rowID, 'demurrage') == true) {
                                   ui.keepEditing = true;
                    ...
                    { name: 'Sorting' },
                   {
                       ...
                       editRowEnding: function (evt, ui) {
                           ...
                           if (ui.update == true && ui.rowAdding == true && ((evt.originalEvent.type == "click" && evt.originalEvent.currentTarget.innerText == "Done") || evt.keyCode == 13)) {
                               ...
                               if (checkToSeeIfNameExsist(ui.values.NAME, 0, 'capacity') == true) {
                                   ui.keepEditing = true;
                                   alert("This alert name already exsist. Please re-name and try saving again");
                                   return false;
                               }
                               ...
                               if (checkToSeeIfNameExsist(ui.values.NAME, ui.rowID, 'capacity') == true) {
                                   ui.keepEditing = true;
                                   alert("There is another alert with this name. Please re-name and try saving again");
                                   return false;
                               }
                    ...
                    { name: 'Sorting' },
                   {
                       ...
                       editRowEnding: function (evt, ui) {
                           ...
                           if (ui.update == true && ui.rowAdding == true && ((evt.originalEvent.type == "click" && evt.originalEvent.currentTarget.innerText == "Done") || evt.keyCode == 13)) {
                               ...
                               if (checkToSeeIfNameExsist(ui.values.NAME, 0, 'inactive') == true) {
                                   ui.keepEditing = true;
                                   alert("This alert name already exsist. Please re-name and try saving again");
                                   return false;
                               }
                               ...
                               if (checkToSeeIfNameExsist(ui.values.NAME, ui.rowID, 'inactive') == true) {
                                   ui.keepEditing = true;
                                   alert("There is another alert with this name. Please re-name and try saving again");
                                   return false;
                               }
                    ...
                    { name: 'Sorting' },
                    {
                        ...
                        editRowEnding: function (evt, ui) {
                            ...
                            if (ui.update == true && ui.rowAdding == true && ((evt.originalEvent.type == "click" && evt.originalEvent.currentTarget.innerText == "Done") || evt.keyCode == 13)) {
                                ...
                                if (checkToSeeIfNameExsist(ui.values.NAME, 0, 'dealBreaker') == true) {
                                    ui.keepEditing = true;
                                    alert("This alert name already exsist. Please re-name and try saving again");
                                    return false;
                                }
                                ...
                                if (checkToSeeIfNameExsist(ui.values.NAME, ui.rowID, 'dealBreaker') == true) {
                                    ui.keepEditing = true;
                                    alert("There is another alert with this name. Please re-name and try saving again");
                                    return false;
                                }
                    ...
                    { name: 'Sorting' },
                    {
                        ...
                        editRowEnding: function (evt, ui) {
                            ...
                            if (ui.update == true && ui.rowAdding == true && ((evt.originalEvent.type == "click" && evt.originalEvent.currentTarget.innerText == "Done") || evt.keyCode == 13)) {
                                ...
                                var mins = convertMinsToHours(ui.values.HOURS);
                                mins + ui.values.mins;

                                if (checkToSeeIfNameExsist(ui.values.NAME, 0, 'dropTrailer') == true) {
                                    ui.keepEditing = true;
                                    alert("This alert name already exsist. Please re-name and try saving again");
                                    return false;
                                }
                                ...
                                if (checkToSeeIfNameExsist(ui.values.NAME, ui.rowID, 'dropTrailer') == true) {
                                    ui.keepEditing = true;
                                    alert("There is another alert with this name. Please re-name and try saving again");
                                    return false;
                                }
                    ...
                    { name: 'Sorting' },
                    {
                        ...
                        editRowEnding: function (evt, ui) {
                            ...
                            if (ui.update == true && ui.rowAdding == true && ((evt.originalEvent.type == "click" && evt.originalEvent.currentTarget.innerText == "Done") || evt.keyCode == 13)) {
                                ...
                                if (checkToSeeIfNameExsist(ui.values.NAME, 0, 'COFAUpload') == true) {
                                    ui.keepEditing = true;
                                    alert("This alert name already exsist. Please re-name and try saving again");
                                    return false;
                                }
                                ...
                                if (checkToSeeIfNameExsist(ui.values.NAME, ui.rowID, 'COFAUpload') == true) {
                                    ui.keepEditing = true;
                                    alert("There is another alert with this name. Please re-name and try saving again");
                                    return false;
                                }
                    ...
                    { name: 'Sorting' },
                    {
                        ...
                        editRowEnding: function (evt, ui) {
                            ...
                            if (ui.update == true && ui.rowAdding == true && ((evt.originalEvent.type == "click" && evt.originalEvent.currentTarget.innerText == "Done") || evt.keyCode == 13)) {
                                ...
                                if (checkToSeeIfNameExsist(ui.values.NAME, 0, 'event') == true) {
                                    ui.keepEditing = true;
                                    alert("This alert name already exsist. Please re-name and try saving again");
                                    return false;
                                }
                                else {
                                    if (ui.values.PRODUCT != "ALL") {
                                ...
                                if (checkToSeeIfNameExsist(ui.values.NAME, ui.rowID, 'event') == true) {
                                    ui.keepEditing = true;
                                    alert("There is another alert with this name. Please re-name and try saving again");
                                    return false;
                                }
    ...
    <div id="demurrageGridWrapper"><table id="demurrageGrid"></table></div>
    ...
    <div id="capacityGridWrapper"><table id="capacityGrid"></table></div>
    ...
    <div id="inactiveGridWrapper"><table id="inactiveGrid"></table></div>
    ...
    <div id="inspectionDealBreakerGridWrapper"><table id="inspectionDealBreakerGrid"></table></div>
    ...
    <div id="dropTrailerGridWrapper"><table id="dropTrailerGrid"></table></div>
    ...
    <div id="COFAUploadGridWrapper"><table id="COFAUploadGrid"></table></div>
    ...
    <div id="EventGridWrapper"><table id="eventGrid"></table></div>
